...
<div class="container" style="margin-top: 50px;">
    ...
    <div class="container text-center" style="margin-top: 50px;">
        <h1>Добро пожаловать в наш магазин строительных материалов!</h1>
        <p class="lead">Все для строительства и ремонта с доставкой на дом</p>
    </div>
            ...
            <div class="col-md-8">
                <p class="lead">
                    Данный интернет-магазин был разработан в качестве курсовой работы по предмету <strong>"Базы
                        данных"</strong>
                    в <strong>УЛГТУ</strong> студентом 3 курса <strong>Саранцевым Семёном Александровичем</strong>.
                </p>
                <p class="lead">
                    Руководителем проекта является <strong>Родионов Вадим Вадимович</strong> —
                    кафедра <strong>ИВК</strong> факультета <strong>ФИСТ</strong>.
                </p>
            </div>
            <div class="col-md-4">
                <img src="../template/assets/11.jpg" class="img-fluid rounded" alt="worker">
            </div>
        </div>
    </div>
</div>
